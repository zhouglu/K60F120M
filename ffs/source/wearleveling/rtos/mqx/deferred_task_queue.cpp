...
*****************************************************************************
* $FileName: deferred_task_queue.cpp$
* $Version : 3.8.0.1$
* $Date    : Aug-9-2012$
*
* Comments: ! \brief Implementation of the nand::DeferredTask class.
*END************************************************************************/
#include "wl_common.h"
...
{ /* Body */
    ...
    m_wl_task_template.TASK_ADDRESS = (void (_CODE_PTR_)(uint_32))taskThreadStub;
    m_wl_task_template.TASK_STACKSIZE = WL_TASK_STACK_SIZE;
    m_wl_task_template.TASK_PRIORITY = WL_TASK_PRIORITY;
    m_wl_task_template.TASK_NAME = WL_TASK_NAME;
    m_wl_task_template.CREATION_PARAMETER = (uint_32)this;/*WL_TASK_CREATION_PARAM;*/
...
{ /* Body */
    ...
    */
    ...
    {
        m_thread = _task_create_blocked(0, 0, (uint_32) &m_wl_task_template);
        /*_task_set_parameter_for((uint_32)this, m_thread);*/
