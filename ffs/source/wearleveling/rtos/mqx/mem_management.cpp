...
{ /* Body */
    uint_32 real_alloc_size = request_size + sizeof(MEM_ENTRY_HEAD)
    ...
    buf_tail = (MEM_ENTRY_TAIL_PTR)((uint_8_ptr) buf_head + request_size
    ...
    if (isZero)
    {
        _mm_internal_zero(((uint_8_ptr) buf_head) + sizeof(MEM_ENTRY_HEAD),
                request_size);
    }/* Endif */
    ...
    */
    ...
    return (((uint_8_ptr) buf_head) + sizeof(MEM_ENTRY_HEAD));
} /* Enbody */
...
{ /* Body */
    ...
    {
        buf_tail = (MEM_ENTRY_TAIL_PTR)(((uint_8_ptr) buf_head)
...
{ /* Body */
    uint_32 i;
    void *buf = ((uint_8_ptr) buf_head) + sizeof(MEM_ENTRY_HEAD);
...
{ /* Body */
    uint_32 ret = MQX_INVALID_POINTER;
    MEM_ENTRY_HEAD_PTR buf_head = (MEM_ENTRY_HEAD_PTR)((uint_8_ptr) buf
            - sizeof(MEM_ENTRY_HEAD));
